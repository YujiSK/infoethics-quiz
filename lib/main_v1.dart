...
class _TitlePageState extends State<TitlePage> {
  ...
  final List<String> _quizOptions = ['assets/data/quiz_1.json', 'assets/data/quiz_2.json'];
...
class QuizPageState extends State<QuizPage> {
  ...
  Future<void> _loadQuizData() async {
    try {
      quizData = await loadQuizData(widget.quizFile); // Updated function call
      _shuffleOptions();
      _updateProgress();
    } catch (e) {
